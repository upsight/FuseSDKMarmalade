...
//	outputLength.
//
void *MarmaladeBase64Decode(const char *inputBuffer, size_t length, size_t *outputLength)
{
	if (length == -1)
	{
...
//	outputLength.
//
char *MarmaladeBase64Encode(const void *buffer, size_t length, bool separateLines, size_t *outputLength)
{
...
//
+ (NSData *)marmaladeDataFromBase64String:(NSString *)aString
{
    NSData *data = [aString dataUsingEncoding:NSUTF8StringEncoding];
	size_t outputLength;
	void *outputBuffer = MarmaladeBase64Decode([data bytes], [data length], &outputLength);
...
//	receiver.
//
- (NSString *)marmaladeBase64EncodedString
{
	size_t outputLength = 0;
	char *outputBuffer = MarmaladeBase64Encode([self bytes], [self length], false, &outputLength);
