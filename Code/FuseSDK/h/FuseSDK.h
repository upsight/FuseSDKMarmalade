 ...
 */
#ifndef S3E_EXT_FUSESDK_H
#define S3E_EXT_FUSESDK_H
...
/**
 * Returns S3E_TRUE if the FuseSDK extension is available.
 */
 ...
 *
 * The available callback types are listed in @ref FuseSDKCallback.
 ...
 *
 * @see FuseSDKUnRegister
 * @note For more information on the system data passed as a parameter to the callback
 * registered using this function, see the @ref FuseSDKCallback enum.
 */
 ...
 * registered using this function, see the FuseSDKCallback enum.
...
* @endcode
* The following callbacks are available with this function: FUSESDK_AD_WILL_CLOSE, FUSESDK_REWARDED_AD_COMPLETED, FUSESDK_IAPOFFER_ACCEPTED, FUSESDK_VIRTUALGOODSOFFER_ACCEPTED
